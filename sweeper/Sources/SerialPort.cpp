...
UINT CSerialPort::CommThread(LPVOID pParam)
{
	...
	DWORD dwError = 0;
	COMSTAT comstat;
	memset(&comstat,0,sizeof(COMSTAT));//Ãß°¡
	BOOL  bResult = TRUE;
...
{		
	...
	m_WriteBufferSize = strlen(string);
...
// Write a string to the port
//
void CSerialPort::WriteToPort(char* Data, UINT size)
{		
	assert(m_hComm != 0);
...
void CSerialPort::WriteToPort(BYTE *Data, UINT size)
{
	assert(m_hComm != 0);
